...
if(isset($_POST['edit_user'])){
    ...
    if($ques==''){
        ...
        echo "<script>alert('Dont leave it empty')</script>";
            ...
            $query="UPDATE question_master SET question_desc= '$ques', status= '$status' WHERE id='$the_user_id'";
            ...
            <center>
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <input type="text" placeholder="Enter the question" value="<?php echo $ques1;?>" name="ques" class="form-control">
                    </div><br>
                    <div class="form-group">
